function __args() {
	...
	if (setting.url.indexOf('http://') !== 0) {
		// setting.url = 'https://xcx.weixinfenxiaoshop.com/index.php/WXAPI' + setting.url;
    setting.url = 'https://fn.fanhouwan.com/index.php/WXAPI' + setting.url;
	}
	return setting;
}
...
module.exports = {
  ...
  getApiUrl: function () {
    return 'https://fn.fanhouwan.com/index.php/WXAPI';
  },
  ...
  getUploadUrl: function() {
    return this.setting.url + '/User/zhiboList/id/'
  }
}
